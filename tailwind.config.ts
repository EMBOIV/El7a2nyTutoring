...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        'glow-orange': '0 0 32px rgba(242,116,5,0.40)',
        'glow-orange-lg': '0 0 60px rgba(242,116,5,0.30)',
        'card-dark': '0 16px 40px rgba(0,0,0,0.50), 0 1px 0 rgba(255,255,255,0.06) inset',
        'card-hover': '0 24px 60px rgba(0,0,0,0.60), 0 0 0 1px rgba(242,116,5,0.15)',
      },
    },
  },
  plugins: [],
