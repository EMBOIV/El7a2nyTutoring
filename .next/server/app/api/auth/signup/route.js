"use strict";(()=>{var e={};e.id=654,e.ids=[654],e.modules={20399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},6005:e=>{e.exports=require("node:crypto")},64725:(e,r,t)=>{t.r(r),t.d(r,{originalPathname:()=>m,patchFetch:()=>y,requestAsyncStorage:()=>c,routeModule:()=>l,serverHooks:()=>x,staticGenerationAsyncStorage:()=>g});var o={};t.r(o),t.d(o,{POST:()=>d});var s=t(49303),n=t(88716),a=t(60670),i=t(87070),p=t(82591);let u=/^[^\s@]+@[^\s@]+\.[^\s@]+$/;async function d(e){try{let r=await e.json(),t=r.name?.trim(),o=r.email?.trim();if(!t||!o||!u.test(o))return i.NextResponse.json({error:"Name and valid email are required"},{status:400});let s=process.env.RESEND_API_KEY;if(!s)return i.NextResponse.json({success:!0});let n=new p.R(s),a=`
      ...
      </div>`;return await n.emails.send({from:"El7a2ny Tutoring <onboarding@resend.dev>",to:o,subject:"Welcome to El7a2ny Tutoring! \uD83C\uDF93",html:a}),i.NextResponse.json({success:!0})}catch(e){return console.error("[SIGNUP EMAIL ERROR]",e),i.NextResponse.json({success:!0})}}let l=new s.AppRouteRouteModule({definition:{kind:n.x.APP_ROUTE,page:"/api/auth/signup/route",pathname:"/api/auth/signup",filename:"route",bundlePath:"app/api/auth/signup/route"},resolvedPagePath:"E:\\El7a2nyTutoring\\app\\api\\auth\\signup\\route.ts",nextConfigOutput:"",userland:o}),{requestAsyncStorage:c,staticGenerationAsyncStorage:g,serverHooks:x}=l,m="/api/auth/signup/route";function y(){return(0,a.patchFetch)({serverHooks:x,staticGenerationAsyncStorage:g})}}};var r=require("../../../../webpack-runtime.js");r.C(e);var t=e=>r(r.s=e),o=r.X(0,[276,972,591],()=>t(64725));module.exports=o})();